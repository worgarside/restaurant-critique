...
UserSchema.methods.sendVerificationEmail = function () {
    ...
    const body = `
        ...
        <p><a href='http://restaurant-critique.willgarside.me/verify-user/${this.verified.hash}'>https://restaurant-critique.willgarside.me/verify-user/${this.verified.hash}</a></p>
    `;
